...
import Adthrottle from '../../../utils/throttle'
...
Page({
  ...
  updateProgress: Adthrottle(function (currentTime) {
  ...
  onSliderChange(event) {
    ...
    playerStore.dispatch("changeMusicStatusAction", true)
  },
  // 节流throttle
  onSliderChanging: Adthrottle(function (event) {
    // 1.获取滑动到的位置的value
    const value = event.detail.value
